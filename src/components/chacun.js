...
export default class Chacun extends Component {
    ...
    componentDidMount() {
        axios.get('http://cusner.herokuapp.com'+this.props.location.pathname)
            .then(response => {
...
<div class="card-body">
  ...
  <img width="100%" height="300px" src={'http://cusner.herokuapp.com/user/'+obj.image} alt="pdp" />
...
console.log(obj._id);
  ...
  <div className='col-md-6'>
    ...
    <button className='btn btn-primary' onClick={(e)=>{
        e.preventDefault()
         axios.get("http://cusner.herokuapp.com/masquer/"+obj._id).then(res=>console.log(res.data)
         )
    ...
    <button className='btn btn-primary' onClick={(e)=>{
        e.preventDefault()
        axios.get("http://cusner.herokuapp.com/affichier/"+obj._id).then(res=>console.log(res.data)
        )
        this.handleActive()
        }}>Activer</button>
